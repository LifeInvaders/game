...
namespace Discord_RPC
{
    ...
    public class PresenceManager : MonoBehaviour
    {
        ...
        public static void UpdateDetails(string detail)
        {
            instance.presence.details = detail;
        ...
        public static void UpdateSize(int presencePartySize)
        {
            instance.presence.partySize = presencePartySize;
            DiscordRpc.UpdatePresence(instance.presence);
        }
        public static void UpdateParty(int presencePartySize, int presencePartySizeMax)
        {
            instance.presence.partySize = presencePartySize;
            instance.presence.partyMax =  presencePartySizeMax;

            DiscordRpc.UpdatePresence(instance.presence);
        }
        
        public static void UpdateJoin(string currentRoomName)
        {
            instance.presence.joinSecret = currentRoomName;
            DiscordRpc.UpdatePresence(instance.presence);
        }
